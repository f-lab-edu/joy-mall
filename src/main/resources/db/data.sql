...
-- CUSTOMER_ADDRESS
insert into CUSTOMER_ADDRESS(CUSTOMER_ID, RECEIPT_NAME, RECEIPT_PHONE_NUMBER, REGION, CITY, TOWN, STREET, ZIP_CODE, DETAIL, CREATED_DATE, UPDATED_DATE)
...
-- sales_group
insert into SALES_GROUP( CREATED_DATE, UPDATED_DATE) VALUES ( now(), now() );
insert into SALES_GROUP( CREATED_DATE, UPDATED_DATE) VALUES ( now(), now() );
insert into SALES_GROUP( CREATED_DATE, UPDATED_DATE) VALUES ( now(), now() );

-- sales_product
insert into SALES_PRODUCT (SALES_GROUP_ID, PRODUCT_OPTION_ID, SALES_PRICE, SALES_STOCK, SALES_STATUS, CREATED_DATE, UPDATED_DATE)
